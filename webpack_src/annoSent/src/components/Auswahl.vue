<template>
  <div class="annosent-auswahl form-horizontal">
    ...
    <!-- TODO: Knöpfe -->
    <template v-if="filterfelder.bearbeitungsmodus === 'direkt' && satz[eintraege.data.selTokenSet] && Object.keys(satz[eintraege.data.selTokenSet]).length > 0 && eintraege.data.tokenSets[eintraege.data.selTokenSet]">
