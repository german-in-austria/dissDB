  ...
  data () {
    return {
      ...
      tabellenfelder: {
        ...
        'von_Inf_id': { show: true, displayName: 'iId' },
        'id': { show: true, displayName: 'antId', dontSort: true },
        'antType': { show: true, dontSort: true },
        'zu_Aufgabe_id': { show: true, displayName: 'aufId' },
        'aufBe': { show: true, dontSort: true },
        'aufVar': { show: true, dontSort: true },
        'vorheriger Satz': { show: true, dontSort: true },
        'Satz': { show: true, dontSort: true },
        'nächster Satz': { show: true, dontSort: true },
        'Sätze in Ortho': { show: true, dontSort: true },
        'Ausgewählte Tokens': { show: true, dontSort: true },
        'Ausgewählte Tokens (Id)': { show: true, dontSort: true },
        'Tagebenen': { show: true, dontSort: true }
      },
