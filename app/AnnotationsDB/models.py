...
class token(models.Model):
	...
	phon				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Phon")
	...
	ttpos				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="TreeTagger POS")
	ttlemma				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="TreeTagger Lemma")
	ttcheckword			= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="TreeTagger Checkword")
	sppos				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy POS")
	sptag				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy Tag")
	splemma				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy Lemma")
	spdep				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy Dependency Relation")
	sphead				= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy Dependency Relation")
	spenttype			= models.CharField(max_length=511			, blank=True, null=True	, db_index=True					, verbose_name="Spacy Named Entity Type")
	updated				= models.DateTimeField(auto_now=True																, verbose_name="Letztes Änderung")
